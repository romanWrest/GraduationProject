package ru.dstu.dormitory.consumables_service.security;
...
import ru.dstu.dormitory.consumables_service.config.JwtProperties;
import ru.dstu.dormitory.consumables_service.domain.enums.RoleCode;
 ...
 * Consumables-service токены не выпускает — только проверяет подпись и извлекает клеймы.
 */
@Component
