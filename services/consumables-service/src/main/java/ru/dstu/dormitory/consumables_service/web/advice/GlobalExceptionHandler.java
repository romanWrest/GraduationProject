package ru.dstu.dormitory.consumables_service.web.advice;
...
import ru.dstu.dormitory.consumables_service.dto.error.ErrorResponseDTO;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(ConsumableTypeNotFoundException.class)
    public ResponseEntity<ErrorResponseDTO> handleTypeNotFound(ConsumableTypeNotFoundException ex) {
        return setErrorResponseDTO(ex, "Тип расходника не найден", HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(ConsumableIssueNotFoundException.class)
    public ResponseEntity<ErrorResponseDTO> handleIssueNotFound(ConsumableIssueNotFoundException ex) {
        return setErrorResponseDTO(ex, "Выдача не найдена", HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<ErrorResponseDTO> handleOutOfStock(OutOfStockException ex) {
        return setErrorResponseDTO(ex, "Недостаточно остатка на складе", HttpStatus.CONFLICT);
    }

    @ExceptionHandler(IssueAlreadyReturnedException.class)
    public ResponseEntity<ErrorResponseDTO> handleAlreadyReturned(IssueAlreadyReturnedException ex) {
        return setErrorResponseDTO(ex, "Выдача уже возвращена", HttpStatus.CONFLICT);
    }

    @ExceptionHandler(IssueNotIssuedException.class)
    public ResponseEntity<ErrorResponseDTO> handleNotIssued(IssueNotIssuedException ex) {
        return setErrorResponseDTO(ex, "Выдача не находится в статусе ISSUED", HttpStatus.CONFLICT);
    }
    ...
    public ResponseEntity<ErrorResponseDTO> handleInvalidStockOperation(InvalidStockOperationException ex) {
        return setErrorResponseDTO(ex, "Некорректная операция со складом", HttpStatus.BAD_REQUEST);
    }
