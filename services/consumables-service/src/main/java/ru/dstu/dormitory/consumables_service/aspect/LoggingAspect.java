...
import ru.dstu.dormitory.consumables_service.util.LogUtil;

import static ru.dstu.dormitory.consumables_service.aspect.annotation.LogMessages.*;
...
public class LoggingAspect {
    ...
    @Around("@annotation(ru.dstu.dormitory.consumables_service.aspect.annotation.LogMethod)")
