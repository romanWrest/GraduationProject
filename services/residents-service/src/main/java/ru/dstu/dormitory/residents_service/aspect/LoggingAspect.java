...
import ru.dstu.dormitory.residents_service.util.LogUtil;

import static ru.dstu.dormitory.residents_service.aspect.annotation.LogMessages.*;
...
public class LoggingAspect {
    ...
    @Around("@annotation(ru.dstu.dormitory.residents_service.aspect.annotation.LogMethod)")
