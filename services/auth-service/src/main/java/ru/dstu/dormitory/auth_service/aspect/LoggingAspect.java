...
import ru.dstu.dormitory.auth_service.util.LogUtil;

import static ru.dstu.dormitory.auth_service.aspect.annotation.LogMessages.*;
 ...
 * <p>Логирует:</p>
 * <ul>
 *     <li>Вход в метод (с опциональным сообщением и аргументами)</li>
 *     <li>Время выполнения</li>
 *     <li>Результат (если {@code logResult = true})</li>
 *     <li>Ошибки</li>
 * </ul>
 */
@Slf4j
...
public class LoggingAspect {
    ...
    @Around("@annotation(ru.dstu.dormitory.auth_service.aspect.annotation.LogMethod)")
