...
import ru.dstu.dormitory.reports_service.util.LogUtil;

import static ru.dstu.dormitory.reports_service.aspect.annotation.LogMessages.*;
...
public class LoggingAspect {
    ...
    @Around("@annotation(ru.dstu.dormitory.reports_service.aspect.annotation.LogMethod)")
