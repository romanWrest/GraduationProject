...
import ru.dstu.dormitory.notifications_service.util.LogUtil;

import static ru.dstu.dormitory.notifications_service.aspect.annotation.LogMessages.*;
...
public class LoggingAspect {
    ...
    @Around("@annotation(ru.dstu.dormitory.notifications_service.aspect.annotation.LogMethod)")
