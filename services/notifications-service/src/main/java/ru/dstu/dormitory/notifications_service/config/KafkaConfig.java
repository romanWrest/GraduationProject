...
public class KafkaConfig {
    ...
    public DefaultErrorHandler kafkaErrorHandler(KafkaTemplate<String, String> kafkaTemplate) {
        ...
        // DECISION: ExponentialBackOffWithMaxRetries добавлен в Spring Framework 6.2,
        // у нас 6.1 (Boot 3.3.5). Используем FixedBackOff с 3 попытками по 2с — этого
        // достаточно для покрытия временных сбоев SMTP/auth перед DLT.
