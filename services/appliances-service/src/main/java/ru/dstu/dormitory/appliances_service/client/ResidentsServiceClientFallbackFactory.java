...
/**
 * Фабрика fallback'ов: на 404 пробрасывает {@link ResidentNotEnrolledException}
 * (бизнес-валидация → 409 на контроллере), на остальные ошибки — graceful
 * деградация с null (контроллер вернёт 503).
 */
@Slf4j
@Component
