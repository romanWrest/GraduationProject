...
import ru.dstu.dormitory.appliances_service.config.KafkaTopicsProperties;
import ru.dstu.dormitory.appliances_service.config.OutboxProperties;
import ru.dstu.dormitory.appliances_service.domain.model.OutboxEvent;
import ru.dstu.dormitory.appliances_service.domain.repo.OutboxEventRepository;
...
public class OutboxRelay {
    ...
    private void publish(OutboxEvent event) {
        try {
            ...
            kafkaTemplate.send(topics.getApplianceEvents(), event.getAggregateId(), wrap(event, payloadNode)).get();
