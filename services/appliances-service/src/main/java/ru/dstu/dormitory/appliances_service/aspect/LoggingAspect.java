...
import ru.dstu.dormitory.appliances_service.util.LogUtil;

import static ru.dstu.dormitory.appliances_service.aspect.annotation.LogMessages.*;
...
public class LoggingAspect {
    ...
    @Around("@annotation(ru.dstu.dormitory.appliances_service.aspect.annotation.LogMethod)")
