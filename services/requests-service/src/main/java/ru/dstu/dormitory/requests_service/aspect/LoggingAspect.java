...
import ru.dstu.dormitory.requests_service.util.LogUtil;

import static ru.dstu.dormitory.requests_service.aspect.annotation.LogMessages.*;
...
public class LoggingAspect {
    ...
    @Around("@annotation(ru.dstu.dormitory.requests_service.aspect.annotation.LogMethod)")
